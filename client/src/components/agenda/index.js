...
function Agenda() {
  return (
    <section className="w-[95%] flex flex-col justify-center items-center md:h-[8rem] text-[17px] mb-20 md:flex-row md:text-[15px] space-x-2.5 m-auto">
      <div className="w-[100%] box mb-4 p-3 md:w-[40%] md:mb-0">
        <p>
      ...
      <div className="w-[100%] box ml-0 p-3 md:w-[40%]">
        <p>
